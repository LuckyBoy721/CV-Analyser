...
def main():
    print("Memuat dataset untuk TF-IDF + SVD Model...")
    ...
    for h in range(len(df_cv)):
        ...
        scores = cosine_similarity(cv_svd, job_svd)
    ...
    df_cv_hasil.to_csv('data/hasil/hasil_tfidf_svd.csv', index=False)
    print("✅ File hasil prediksi berhasil disimpan di: data/hasil/hasil_tfidf_svd.csv")
    
    print(f"\n=== HASIL EVALUASI TF-IDF + SVD ===")
